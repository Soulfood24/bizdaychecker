...
(function () {
  ...
  window.CALC_HQ_NETWORK = [
    ...
    { name: "BizDayChecker.com",       url: "https://salaryvsinflation.com",    live: true,  clusters: ["us", "tax-income"] },
  ...
  function renderFooter() {
    ...
    footerTarget.innerHTML = [
      ...
      '</div>',
      '<p class="footer-meta">BizDayChecker.com · Estimates run locally in your browser.</p>'
    ].join('');
  }
